...
class Mle:
    ...
    def multi_process(self, k, N=30):
        # mle = mle.copy()
        # self.mle_loss(update=1, nbr_iter=N, dim=k)
        # self.plot_loss()
        # self.plot_loss(error='rmse', fgname='rmse', title='RMSE', ylabel='rmse value')
        print(k, N)
...
def multi_process(k, mle=None, N=30):
    ...
    # mle_copy.plot_loss()
    # mle_copy.plot_loss(error='rmse', fgname='rmse', title='RMSE', ylabel='rmse value')
